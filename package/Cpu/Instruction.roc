...
expect decodes_to(0x76, |i| match i {
	Halt => Bool.True
	_ => Bool.False
})
expect decodes_to(0x41, |i| match i {
	Load(Direct8(B), Direct8(C)) => Bool.True
	_ => Bool.False
})
expect decodes_to(0x6E, |i| match i {
	Load(Direct8(L), Indirect(HL)) => Bool.True
	_ => Bool.False
})
expect decodes_to(0x77, |i| match i {
	Load(Indirect(HL), Direct8(Accumulator)) => Bool.True
	_ => Bool.False
})
expect decodes_to(0x87, |i| match i {
	Add(Direct8(Accumulator)) => Bool.True
	_ => Bool.False
})
expect decodes_to(0x9E, |i| match i {
	Sbc(Indirect(HL)) => Bool.True
	_ => Bool.False
})
expect decodes_to(0xB8, |i| match i {
	Compare(Direct8(B)) => Bool.True
	_ => Bool.False
})
expect decodes_to(0xE8, |i| match i {
	AddStackPointerImmediate => Bool.True
	_ => Bool.False
})
expect decodes_to(0xF8, |i| match i {
	LoadHLStackPointerImmediate => Bool.True
	_ => Bool.False
})
expect decodes_to(0xF9, |i| match i {
	Load16(Direct16(StackPointer), Direct16(HL)) => Bool.True
	_ => Bool.False
})
expect decodes_to(0xE9, |i| match i {
	Jump(Always, HL) => Bool.True
	_ => Bool.False
})
