...
NewLicensee : [None, Some Str, Unknown]
...
propMatch : Props -> { len : U64, start : U64 }
propMatch = \input ->
    when input is
...
read = \data ->
    r = \prop -> data |> List.sublist (propMatch prop)
    {
        entry: r Entry,
        logo: r Logo,
        title: r Title |> Str.fromUtf8,
        manufacturer: r Manufacturer |> Str.fromUtf8,
        cgbFlag: r CgbFlag |> mapCgbFlag,
        sgbFlag: r SgbFlag |> mapSgbFlag,
        type: r CartridgeType |> mapType,
        romSize: r RomSize |> mapRomSize,
        ramSize: r RamSize |> mapRamSize,
        oldLicensee: r OldLicensee |> mapOldLicensee,
        newlicensee: r NewLicensee |> mapNewLicensee,
        version: r MaskRomVersion,
        destination: r Destination |> mapDestination,
        checksum: r HeaderChecksum |> mapChecksum data,
    }
